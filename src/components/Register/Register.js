            ...
            <main className="pa4 black-80">
                <form className="measure">
                    ...
                    <div className="mv3">
                        ...
                        <input className="b br2 pa2 input-reset ba bg-transparent w-100" type="password" name="password"  id="password" />
                    </div>
                    <div className="mv3">
                        <label className="db fw6 lh-copy f6" for="password">Comfirm Password</label>
                        <input className="b br2 pa2 input-reset ba bg-transparent w-100" type="password" name="comfirm-password"  id="comfirm-password" />
                    </div>
                    </fieldset>
                    <div className="">
                    <input 
