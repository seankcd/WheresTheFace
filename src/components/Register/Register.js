...
class Register extends React.Component {
    ...
    onSubmitSignIn = () => {
        fetch('https://nameless-coast-34092.herokuapp.com/register', {
            method: 'post',
                ...
                <main className="pa4 black-80">
                    <div className="measure">
                        ...
                        <div className="mv3">
                            ...
                            <input 
                                className="b br2 pa2 input-reset ba bg-transparent w-100" 
                                type="password" 
                                name="password"  
                                id="password" 
                        ...
                        {/* <div className="mv3">
                            <label className="db fw6 lh-copy f6" htmlFor="comfirm-password">Comfirm Password</label>
                            <input 
                                className="b br2 pa2 input-reset ba bg-transparent w-100" 
                                type="password" 
